...
figures:
  - id: fig3
    ...
    caption: "真实数据评估区分二分类与连续性状，以及原有 PRS 的来源。比较应在相同测试集和同一原始评分内进行；相对提升百分比不是 AUC 的绝对百分点。"
    alt: "独立测试集中的 AUC 与解释方差（Figure 3）"
    sourceUrl: "https://www.nature.com/articles/s41467-026-77128-5/figures/3"
  ...
  - id: fig7
    ...
    alt: "高风险分层在 UKBB 和外部队列中的表现（Figure 7）"
    sourceUrl: "https://www.nature.com/articles/s41467-026-77128-5/figures/7"
...
这与此前收录的罕见变异非加性检验也不是同一个任务：后者侧重检验基因剂量关系偏离加性，AB-PRS 则侧重在现有预测器上增加有效信息。LD 下的标记效应、原始模型遗漏及目标队列差异，都可能产生可用于预测的补充项。
